            ...
            let Some(group) = context.managed_groups.iter().find(|group| group.group_id == group_id).cloned() else {
                return rsx! {
                    section { class: "page-section",
                        Card { class: "home-intro-card",
                            CardHeader {
                                CardTitle { "Gruppe nicht verfügbar" }
                                CardDescription {
                                    "Du kannst nur Gruppen öffnen, die dir als Trainer zugewiesen sind."
                                }
                            }
                        }
                    }
                            ...
                            CardContent {
                                ...
                                match training_state {
                                    ...
                                    Some(Ok(trainings)) if trainings.is_empty() => rsx! {
                                        p { class: "auth-help", "Für diese Gruppe wurden noch keine Trainings geplant." }
                                    },
                                    Some(Ok(trainings)) => {
